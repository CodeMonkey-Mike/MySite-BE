...
// const PORT = 9015;
const SERVED_FOLDER = '/home/dominitech/workspace/mikeneder.me/mikeneder-be/master';
...
const main = async () => {
  try {
    ...
    // Reload staging site
    await exec('/home/dominitech/.npm-global/bin/pm2 reload api-mn-staging'); 
    ...
    const cleanup = async (prNumber) => {
      ...
      await exec(`echo '${SUDO_PASSWORD}' | sudo -S rm -rf /home/dominitech/workspace/${DOMAIN}/mikeneder-be/${prNumber}`);
